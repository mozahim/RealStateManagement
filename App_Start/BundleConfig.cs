    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/angular-material").Include(
                        ...
                        "~/Content/flaticon/flaticon.css"));

            bundles.Add(new StyleBundle("~/Scripts/angular").Include(
            ...
            bundles.Add(new StyleBundle("~/Scripts/angularapp").Include(
                        "~/Scripts/angular-app/app.js",
                        "~/Scripts/angular-app/controllers.js",
                        "~/Scripts/angular-app/services.js"));
